...
A manually approved dependency report associated with a Jira Task triggered this isolated demo automation.
...
6. Create a unique branch beginning `fix/<jira-key>-log4j` and a draft PR targeting `demo/log4j`; append a numeric suffix if needed.
